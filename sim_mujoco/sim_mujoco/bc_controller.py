...
class PolicyBC:
    def __init__(self, state_size, action_size, num_input_states):
        ...
        self.policy_name = 'bc_v4_fixed_data_all_normalized_no_duplicate_inputs'
        ...
        with open("/home/leo/biped_ws/src/biped/sim_mujoco/imit_learning_setup/data_processing/updated_data/action_scaler_v4.pkl", "rb") as f:
            self.scaler_a = load(f)

        with open("/home/leo/biped_ws/src/biped/sim_mujoco/imit_learning_setup/data_processing/updated_data/state_scaler_v4.pkl", "rb") as f:
    ...
    def __call__(self, input_state):
        ...
        scaled_input_state = self.scaler_s.transform(input_state)
