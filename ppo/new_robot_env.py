...
from gymnasium import utils, register
...
class BipedEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release
    ...
    def __init__(
        self,
        xml_file: str = "/home/zhonghezheng13579/ros_ws/src/biped/biped_robot_description/urdf/custom_robot.mujoco.xml",
        frame_skip: int = 4,
...
register(
id="gymnasium_env/BipedEnv",
entry_point=BipedEnv,
)
print("Registered")