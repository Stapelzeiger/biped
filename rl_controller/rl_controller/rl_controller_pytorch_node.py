...
from rl_controller.rl_controller_pytorch import RL_Controller


# Load results folder path from environment variable with fallback.
POLICY_PATH = os.getenv('POLICY_PATH_PYTORCH',
                        '~/.ros/policy_pytorch')

class JointTrajectoryPublisher(Node):

    def __init__(self):
        super().__init__('joint_trajectory_publisher_pytorch')
        ...
        self.action_size = self.configs_training['action_size']
